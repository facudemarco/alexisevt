...
export default async function CategoryPage({ params }: Params) {
  ...
  const isElegiDondeViajar =
    decodedSlug.toLowerCase() === "elegi-donde-viajar" ||
    decodedSlug.toLowerCase() === "elegi-cuando-viajar" ||
    decodedSlug.toLowerCase() === "individuales";
